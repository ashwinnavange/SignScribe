...
import 'package:signscribe/sign2voice.dart';
import 'package:signscribe/utils/colors.dart';
import 'package:signscribe/utils/sizes.dart';
import 'package:signscribe/voice2sign.dart';
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: SlidingUpPanel(
            ...
            minHeight: displayHeight(context) * 0.62,
            ...
            body: Padding(
              padding: const EdgeInsets.only(left:30,top:23,right: 15),
              child: Column(
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: (){
                          Navigator.push(
                            context,
                            SlideRightRoute(page: const Settings()),
                          );
                        },
                        icon: const Icon(
                            Icons.settings,
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Text(
                          'Breaking Barriers, Bridging Worlds',
                          style: TextStyle(
                            fontFamily: 'Comfortaa',
                              ...
                              child: ClipRRect(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      SlideRightRoute(page: const SignToVoice()),
                                    );
                                  },
                                  child: Center(
                                    child: Row(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        SlideRightRoute(page: const VoiceToSign()),
                                      );
                                    },
                                    child: Center(
                                      child: Row(
